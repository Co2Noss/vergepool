...
define('YIIMP_MYSQLDUMP_USER', 'website');
define('YIIMP_MYSQLDUMP_PASS', 'z4ovLupdpXM9WCsp');

/* Keys required to create/cancel orders and access your balances/deposit addresses */
define('EXCH_BITTREX_SECRET', '');
define('EXCH_BITSTAMP_SECRET','');
define('EXCH_BINANCE_SECRET', 'Chlhxpsw09uq1qQ7g0UsG4o1oijpnGgX45Yni2w1EMfbxFomTfZyg4j6BmtSo0r6');
